...
import rohan.groups.sunrisedelivery.Forgotpassword.ForgotPassword;
...
public class OtpVerfification extends AppCompatActivity {
                ...
                final String user = "+91" + Tmobile.getText().toString();
                            ...
                            if (Tverify.getVisibility() == View.INVISIBLE) {
                                ...
                                if (Tmobile.getText() == null) {
                                    Toast.makeText(OtpVerfification.this, "Enter Mobile Number", Toast.LENGTH_SHORT).show();
                                    return;
                                }
                                if (Tmobile.getText().length() != 10) {
                                    Toast.makeText(OtpVerfification.this, "Enter Valid Mobile Number", Toast.LENGTH_SHORT).show();
                                    return;
                                }
    ...
    private void verifyPhoneNumberWithCode(String verificationId, String code) {
        ...
        try {
            ...
            Tverify.setError("Enter Valid OTP");
            return;
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Orders1").child(pushid).child("Verified").setValue("Yes");

                            session = new Session(OtpVerfification.this);
                            session.setverified("Yes");
    ...
    private void signInAnonymously() {
        mAuth.signInAnonymously().addOnSuccessListener(OtpVerfification.this, new  OnSuccessListener<AuthResult>() {
            @Override
            public void onSuccess(AuthResult authResult) {
                // do your stuff
            }
        })
                .addOnFailureListener(OtpVerfification.this, new OnFailureListener() {
                    @Override
