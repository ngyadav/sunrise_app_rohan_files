...
window.onload = function () {
    ...
    .orderByChild("Category").equalTo("HomeAppliances")
...
$('#sname').on('change',function(){
    ...
    if(sname.options[sname.selectedIndex].value=="Select")
        {
            alert("Select HomeAppliances Name");
            sname.focus();
            return;
        }
...
submitbtn.addEventListener("click", function () {
    ...
    firebaseref.child("Category").set("HomeAppliances");
    firebaseref.child("CategoryName").set("HomeAppliances "+name.value.trim());
    firebaseref.child("CategoryType").set("HomeAppliances "+type.options[type.selectedIndex].value);
    firebaseref.child("CategoryBrand").set("HomeAppliances "+brand.value);
...
$("#mimage1").change(function(){
    ...
    window.mtemp--;
     ...
     const ref = firebase.storage().ref("/Homeappliances/");
...
submitbtn1.addEventListener('click',function(){
    ...
    var firebaseref=firebase.database().ref().child("AppContent").child("Homeappliances").child("Baner").child(mname.options[mname.selectedIndex].value);
    firebaseref.child(mname.options[mname.selectedIndex].value).set(window.path4);
...
submitbtn2.addEventListener('click',function(){
    ...
    var firebaseref=firebase.database().ref().child("AppContent").child("Homeappliances").child(mname.options[mname.selectedIndex].value);
