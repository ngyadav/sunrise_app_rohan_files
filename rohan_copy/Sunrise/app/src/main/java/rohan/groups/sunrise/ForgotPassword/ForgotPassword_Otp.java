...
public class ForgotPassword_Otp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgot_password__otp);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            if (Tverify.getVisibility() == View.INVISIBLE) {
                                ...
                                if (TextUtils.isEmpty(Tmobile.getText().toString())) {
                                    Tmobile.setError("Enter Products Number");
                                    Tmobile.requestFocus();
                                    return;
                                }
                                if (Tmobile.getText().length() != 10) {
                                    Tmobile.setError("Enter proper mobile number");
                                    Tmobile.requestFocus();
                                    return;
                                }
                            ...
                            Tmobile.setError("User Not Registered");
                            Tmobile.requestFocus();
                            return;
                        }
                    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if(TextUtils.isEmpty(Tmobile.getText().toString())){
                                Toast.makeText(ForgotPassword_Otp.this,"Technical Error.Error Code #1200. Try after sometime or contact admin",Toast.LENGTH_SHORT).show();
                                return;
                            }
                            // [START_EXCLUDE]
                            Intent intent=new Intent(ForgotPassword_Otp.this, ForgotPassword.class);
                            intent.putExtra("mobile", Tmobile.getText().toString());
    ...
    private void signInAnonymously() {
        mAuth.signInAnonymously().addOnSuccessListener(ForgotPassword_Otp.this, new  OnSuccessListener<AuthResult>() {
            @Override
            public void onSuccess(AuthResult authResult) {
                // do your stuff
            }
        })
                .addOnFailureListener(ForgotPassword_Otp.this, new OnFailureListener() {
                    @Override
