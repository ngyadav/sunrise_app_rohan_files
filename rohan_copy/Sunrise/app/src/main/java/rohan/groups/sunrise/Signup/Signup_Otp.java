...
import rohan.groups.sunrise.ForgotPassword.ForgotPassword;
...
public class Signup_Otp extends AppCompatActivity {
                ...
                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (!dataSnapshot.exists()) {
                            ...
                            Tmobile.setError("User  Registered");
                            Tmobile.requestFocus();
                            return;
                        }
                    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if(TextUtils.isEmpty(Tmobile.getText().toString())){
                                Toast.makeText(Signup_Otp.this,"Technical Error.Error Code #1200. Try after sometime or contact admin",Toast.LENGTH_SHORT).show();
                                return;
                            }
                            ...
                            // [START_EXCLUDE]
                            Intent intent=new Intent(Signup_Otp.this, PasswordSignup.class);
    ...
    private void signInAnonymously() {
        mAuth.signInAnonymously().addOnSuccessListener(Signup_Otp.this, new  OnSuccessListener<AuthResult>() {
            @Override
            public void onSuccess(AuthResult authResult) {
                // do your stuff
            }
        })
                .addOnFailureListener(Signup_Otp.this, new OnFailureListener() {
                    @Override
