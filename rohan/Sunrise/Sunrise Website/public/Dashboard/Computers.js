...
window.onload = function () {
    ...
    .orderByChild("Category").equalTo("Computer")
...
submitbtn.addEventListener("click", function () {
    ...
    firebaseref.child("Category").set("Computer");
    firebaseref.child("CategoryName").set("Computer "+name.value.trim());
    firebaseref.child("CategoryType").set("Computer "+type.options[type.selectedIndex].value);
    firebaseref.child("CategoryBrand").set("Computer "+brand.value);
...
$("#mimage1").change(function(){
    ...
    window.mtemp--;
     ...
     const ref = firebase.storage().ref("/Computer/");
...
submitbtn1.addEventListener('click',function(){
    ...
    var firebaseref=firebase.database().ref().child("AppContent").child("Computer").child("Baner").child(mname.options[mname.selectedIndex].value);
...
submitbtn2.addEventListener('click',function(){
    ...
    var firebaseref=firebase.database().ref().child("AppContent").child("Computer").child(mname.options[mname.selectedIndex].value);
