...
window.onload = function () {
        ...
        .orderByChild("Category").equalTo("Accesories")
...
submitbtn.addEventListener("click", function () {
    ...
    firebaseref.child("Category").set("Accesories");
    firebaseref.child("CategoryName").set("Accesories "+name.value.trim());
    firebaseref.child("CategoryType").set("Accesories "+type.options[type.selectedIndex].value);
    firebaseref.child("CategoryBrand").set("Accesories "+brand.value);
...
$("#mimage1").change(function(){
    ...
    window.mtemp--;
     ...
     const ref = firebase.storage().ref("/Accesories/");
...
submitbtn1.addEventListener('click',function(){
    ...
    var firebaseref=firebase.database().ref().child("AppContent").child("Accesories").child("Baner").child(mname.options[mname.selectedIndex].value);
...
submitbtn2.addEventListener('click',function(){
    ...
    var firebaseref=firebase.database().ref().child("AppContent").child("Accesories").child(mname.options[mname.selectedIndex].value);
