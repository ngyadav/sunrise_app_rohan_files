...
public class MobileFragment extends Fragment {
    ...
    ImageView hsamsung,hmi,hoppo,hnokia,hvivo;
...
//        FirebaseDatabase.getInstance().getReference().child("AppContent").child("Mobile").child("Baner")
...
//                });
        ...
        DatabaseReference ref = database.child("AppContent").child("Mobile").child("Baner");
        ...
        FirebaseDatabase.getInstance().getReference().child("AppContent").child("Mobile")
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                        if(dataSnapshot.child("Mobile1").exists()){
                            Glide.with(getContext())
                                    .load(dataSnapshot.child("Mobile1").child("Image1").getValue().toString())
                                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                                    .into(n1);

                            nname1.setText(dataSnapshot.child("Mobile1").child("Name").getValue().toString());
                            nprice1.setText("\u20b9 "+dataSnapshot.child("Mobile1").child("Price").getValue().toString());
                            nrewards1.setText(dataSnapshot.child("Mobile1").child("Cashback").getValue().toString()+" Rewards Points");
                            npushid1.setText(dataSnapshot.child("Mobile1").child("PushId").getValue().toString());


                        }

                        if(dataSnapshot.child("Mobile2").exists()){
                            Glide.with(getContext())
                                    .load(dataSnapshot.child("Mobile2").child("Image1").getValue().toString())
                                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                                    .into(n2);

                            nname2.setText(dataSnapshot.child("Mobile2").child("Name").getValue().toString());
                            nprice2.setText("\u20b9 "+dataSnapshot.child("Mobile2").child("Price").getValue().toString());
                            nrewards2.setText(dataSnapshot.child("Mobile2").child("Cashback").getValue().toString()+" Rewards Points");
                            npushid2.setText(dataSnapshot.child("Mobile2").child("PushId").getValue().toString());


                        }


                        if(dataSnapshot.child("Mobile3").exists()){
                            Glide.with(getContext())
                                    .load(dataSnapshot.child("Mobile3").child("Image1").getValue().toString())
                                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                                    .into(n3);

                            nname3.setText(dataSnapshot.child("Mobile3").child("Name").getValue().toString());
                            nprice3.setText("\u20b9 "+dataSnapshot.child("Mobile3").child("Price").getValue().toString());
                            nrewards3.setText(dataSnapshot.child("Mobile3").child("Cashback").getValue().toString()+" Rewards Points");
                            npushid3.setText(dataSnapshot.child("Mobile3").child("PushId").getValue().toString());
                        ...
                        if(dataSnapshot.child("Mobile4").exists()){
                            Glide.with(getContext())
                                    .load(dataSnapshot.child("Mobile4").child("Image1").getValue().toString())
                                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                                    .into(n4);

                            nname4.setText(dataSnapshot.child("Mobile4").child("Name").getValue().toString());
                            nprice4.setText("\u20b9 "+dataSnapshot.child("Mobile4").child("Price").getValue().toString());
                            nrewards4.setText(dataSnapshot.child("Mobile4").child("Cashback").getValue().toString()+" Rewards Points");
                            npushid4.setText(dataSnapshot.child("Mobile4").child("PushId").getValue().toString());
