...
public class CurrentDetailsGrocery extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v=inflater.inflate(R.layout.fragment_current_details_grocery, container, false);
