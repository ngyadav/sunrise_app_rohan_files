...
public class OtpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bverify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("DeliveryBoys");
                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.hasChild(Tmobile.getText().toString())) {
                            ...
                            Toast.makeText(OtpActivity.this,"User Not Registered",Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            session.setusername(Tmobile.getText().toString());
    ...
    private void signInAnonymously() {
        mAuth.signInAnonymously().addOnSuccessListener(OtpActivity.this, new  OnSuccessListener<AuthResult>() {
            @Override
