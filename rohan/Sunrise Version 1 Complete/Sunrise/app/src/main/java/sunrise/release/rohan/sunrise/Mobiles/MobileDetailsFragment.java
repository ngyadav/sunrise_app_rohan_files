...
public class MobileDetailsFragment extends Fragment  implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    String currentString = mobile.Colour;
                        ...
                        builder.setCancelable(false)
                                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        if(sizeselected==0)
                                        {
                                            if(color.getVisibility()==View.VISIBLE) {
                                                Toast.makeText(getContext(), "Please Select Color", Toast.LENGTH_SHORT).show();
                                                return;
                                            }
                                        }
                                        ...
                                        ref.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                if(color.getVisibility()==View.VISIBLE)
                                                ref.child("Colour").setValue(array[sizeselected].getText());
                                                else
                                                    ref.child("Colour").setValue("");
