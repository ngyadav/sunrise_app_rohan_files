...
import sunrise.release.rohan.sunrise.Fashion.ViewHolder;
...
//        mRecyclerView.setLayoutManager(new GridLayoutManager(getContext(), 2));
        ...
        hSaree.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseRecyclerAdapter<Fashion, ViewHolder> firebaseRecyclerAdapter =
                        new FirebaseRecyclerAdapter<Fashion,ViewHolder>(
                                Fashion.class,
                            ...
                            @Override
                            protected void populateViewHolder(ViewHolder viewHolder, Fashion profile, int position) {
                            ...
                            public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                                ...
                                viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                                    ...
                                    public void onItemClick(View v, int position) {
                                        ...
                                        FashionDetails fragment= new FashionDetails();
    ...
    private  void firebasesearch(final String searchText)
    {
        ...
        shimmer.setVisibility(View.VISIBLE);
        shimmer.startShimmer();
        Query firebasesearchquery = mref.orderByChild("Category").equalTo("Fashion");
