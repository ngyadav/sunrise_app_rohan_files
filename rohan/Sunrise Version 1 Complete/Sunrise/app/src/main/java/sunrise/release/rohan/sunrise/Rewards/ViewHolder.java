...
//        Item Click
    ...
    public void setDetails(final Context ctx, String Amount, String Balance, String Date, String Name, String TransactionId, String Type, String OrderNumber, int position){
