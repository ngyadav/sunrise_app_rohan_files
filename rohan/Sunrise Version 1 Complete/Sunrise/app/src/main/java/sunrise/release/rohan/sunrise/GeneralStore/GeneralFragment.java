...
import sunrise.release.rohan.sunrise.GeneralStore.ViewHolder;
...
public class GeneralFragment extends Fragment {
    ...
    ImageView hfood,hdetergents,hcosmetics,hsunrise,hothers;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        hdetergents=(ImageView)v.findViewById(R.id.hdetergent);
        hcosmetics=(ImageView)v.findViewById(R.id.hcosmetics);
        hsunrise=(ImageView)v.findViewById(R.id.hsunrise);
        hothers=(ImageView)v.findViewById(R.id.hothers);
        shimmer=v.findViewById(R.id.shimmer);
        mRecyclerView = v.findViewById(R.id.recyclerviewgeneral);
...
//        mRecyclerView.setLayoutManager(new GridLayoutManager(getContext(), 2));
        ...
        hfood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                session.setsub("General FOOD");
                Query firebasequery=mref.orderByChild("CategoryType").equalTo("General FOOD");
                FirebaseRecyclerAdapter<General, ViewHolder> firebaseRecyclerAdapter =
                        new FirebaseRecyclerAdapter<General, ViewHolder>(
                                General.class,
                            ...
                            @Override
                            protected void populateViewHolder(ViewHolder viewHolder, General profile, int position) {
        ...
        hdetergents.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mRecyclerView.setVisibility(View.GONE);
                shimmer.setVisibility(View.VISIBLE);
                shimmer.startShimmer();
                session.setsub("General DETERGENTS");
                Query firebasequery=mref.orderByChild("CategoryType").equalTo("General DETERGENTS");
                FirebaseRecyclerAdapter<General, ViewHolder> firebaseRecyclerAdapter =
                        new FirebaseRecyclerAdapter<General, ViewHolder>(
                                General.class,
                                R.layout.cardview_mobile,
        ...
        hcosmetics.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mRecyclerView.setVisibility(View.GONE);
                shimmer.setVisibility(View.VISIBLE);
                shimmer.startShimmer();
                session.setsub("General COSMETICS");
                Query firebasequery=mref.orderByChild("CategoryType").equalTo("General COMSETICS");
                FirebaseRecyclerAdapter<General, ViewHolder> firebaseRecyclerAdapter =
                        new FirebaseRecyclerAdapter<General, ViewHolder>(
                                General.class,
                                R.layout.cardview_mobile,
        ...
        hsunrise.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mRecyclerView.setVisibility(View.GONE);
                shimmer.setVisibility(View.VISIBLE);
                ...
                Query firebasequery=mref.orderByChild("CategoryType").equalTo("General SUNRISE");
                FirebaseRecyclerAdapter<General, ViewHolder> firebaseRecyclerAdapter =
                        new FirebaseRecyclerAdapter<General, ViewHolder>(
                                General.class,
                                R.layout.cardview_mobile,
        ...
        hothers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                shimmer.setVisibility(View.VISIBLE);
                shimmer.startShimmer();
                session.setsub("General OTHERS");
                Query firebasequery=mref.orderByChild("CategoryType").equalTo("General OTHERS");
                FirebaseRecyclerAdapter<General, ViewHolder> firebaseRecyclerAdapter =
                        new FirebaseRecyclerAdapter<General, ViewHolder>(
                                General.class,
                                R.layout.cardview_mobile,
    ...
    private  void firebasesearch(final String searchText)
    {
        ...
        shimmer.setVisibility(View.VISIBLE);
        shimmer.startShimmer();
        Query firebasesearchquery = mref.orderByChild("Category").equalTo("General");
