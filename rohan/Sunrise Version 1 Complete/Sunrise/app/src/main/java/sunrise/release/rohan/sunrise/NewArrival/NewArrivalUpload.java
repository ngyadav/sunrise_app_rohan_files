...
public class NewArrivalUpload extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_new_arrival_upload, container, false);
        ...
        mSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference ref= FirebaseDatabase.getInstance().getReference().child("Category").child("NewArrival").child(mName.getText().toString());
                ...
                if(temp==0) {
                    ...
                    ref.child("Category").setValue("NewArrival");
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild(mName.getText().toString())) {
                            ...
                            ref.addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    NewArrival mobile = dataSnapshot.getValue(NewArrival.class);
