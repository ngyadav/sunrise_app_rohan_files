...
public class FashionUploadFragment extends Fragment {
    ...
    Spinner mType;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View v=inflater.inflate(R.layout.fragment_fashion_upload, container, false);
            ...
            areas.add("SAREE");
            areas.add("WATCHES");
            areas.add("MENSFASHION");
            areas.add("WOMENSFASHION");
            areas.add("KIDSFASHION");
            areas.add("OTHERS");
            ...
            mSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    DatabaseReference ref= FirebaseDatabase.getInstance().getReference().child("Category").child("Fashion").child(mName.getText().toString());
                    ...
                    if(temp==0) {
                        ...
                        ref.child("Category").setValue("Fashion");
            ...
            mSearch.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    DatabaseReference ref = database.child("Category").child("Fashion");
                    ref.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if(dataSnapshot.hasChild(mName.getText().toString())) {
                                DatabaseReference ref = database.child("Category").child("Fashion").child(mName.getText().toString());
