...
import sunrise.release.rohan.sunrise.Stationary.ViewHolder;
...
public class StationaryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = v.findViewById(R.id.recyclerviewstationary);
...
//        mRecyclerView.setLayoutManager(new GridLayoutManager(getContext(), 2));
    ...
    public void onStart() {
        ...
        Query firebasequery=mref.orderByChild("Category").equalTo("Stationary");
        FirebaseRecyclerAdapter<Stationary, ViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Stationary, ViewHolder>(
                        Stationary.class,
                    ...
                    @Override
                    protected void populateViewHolder(ViewHolder viewHolder, Stationary profile, int position) {
                    ...
                    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                        ...
                        viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                            ...
                            public void onItemClick(View v, int position) {
                                ...
                                StationaryDetailsFragment fragment= new StationaryDetailsFragment();
    ...
    private  void firebasesearch(final String searchText)
    {
        ...
        shimmer.setVisibility(View.VISIBLE);
        shimmer.startShimmer();
        Query firebasesearchquery = mref.orderByChild("Category").equalTo("Stationary");
