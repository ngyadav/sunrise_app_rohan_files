...
public class HomeAppliancesUploadFragment extends Fragment {
    List<String> areas = new ArrayList<String>();
    Spinner mType;
    TextView mName,mPrice,mCashback,mFeature1,mFeature2,mFeature3,mFeature4,mFeature5,mFeature6,mBrand,mRatings,mQuantity,mSearch;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_home_appliances_upload, container, false);
        mName=(TextView)v.findViewById(R.id.mName);
        mPrice=(TextView)v.findViewById(R.id.mPrice);
        mCashback=(TextView)v.findViewById(R.id.mCashback);
        mFeature1=(TextView)v.findViewById(R.id.mFeature1);
        mFeature2=(TextView)v.findViewById(R.id.mFeature2);
        mFeature3=(TextView)v.findViewById(R.id.mFeature3);
        mFeature4=(TextView)v.findViewById(R.id.mFeature4);
        mFeature5=(TextView)v.findViewById(R.id.mFeature5);
        mFeature6=(TextView)v.findViewById(R.id.mFeature6);
        mFeature7=(TextView)v.findViewById(R.id.mFeature7);
        mFeature8=(TextView)v.findViewById(R.id.mFeature8);
        mFeature9=(TextView)v.findViewById(R.id.mFeature9);
        mFeature10=(TextView)v.findViewById(R.id.mFeature10);
        mFeature11=(TextView)v.findViewById(R.id.mFeature11);
        mFeature12=(TextView)v.findViewById(R.id.mFeature12);
        mBrand=(TextView)v.findViewById(R.id.mBrand);
        mType=(Spinner)v.findViewById(R.id.mType);
        mRatings=(TextView)v.findViewById(R.id.mRatings);
        mQuantity=(TextView)v.findViewById(R.id.mQuantity);
        mSubmit=(Button)v.findViewById(R.id.mSubmit);
        mProgress=(ProgressBar)v.findViewById(R.id.mProgress);
        mScrollView=(ScrollView)v.findViewById(R.id.mScrollView);
        mProgress.setVisibility(View.GONE);
        mSearch=(TextView)v.findViewById(R.id.mobile_upload_search);


        areas.add("TELEVISION");
        areas.add("WASHING");
        areas.add("REFRIGERATOR");
        areas.add("KITCHEN");
        areas.add("OTHERS");

        ArrayAdapter<String> areasAdapter = new ArrayAdapter<String>(getContext(), R.layout.spinner_layout, areas);
        areasAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        mType.setAdapter(areasAdapter);
        ...
        mSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mBrand.getText().toString().equalsIgnoreCase(""))
                {
                    Toast.makeText(getContext(),"Enter Brand",Toast.LENGTH_SHORT).show(); mName.requestFocus();
                    mScrollView.fullScroll(ScrollView.FOCUS_UP);
                    mBrand.requestFocus();
                    return;
                }
                ...
                DatabaseReference ref= FirebaseDatabase.getInstance().getReference().child("Category").child("HomeAppliances").child(mName.getText().toString());
                ...
                ref.child("Brand").setValue(mBrand.getText().toString());
                ref.child("Type").setValue(mType.getSelectedItem().toString());
                ...
                if(temp==0) {
                    ...
                    ref.child("Category").setValue("HomeAppliances");
        ...
        mSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference ref = database.child("Category").child("HomeAppliances");
                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild(mName.getText().toString())) {
                            DatabaseReference ref = database.child("Category").child("HomeAppliances").child(mName.getText().toString());
                            ref.addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    Home mobile = dataSnapshot.getValue(Home.class);
                                    ...
                                    mBrand.setText(mobile.Brand);
                                    mType.setSelection(getIndex(mType,mobile.Type));
