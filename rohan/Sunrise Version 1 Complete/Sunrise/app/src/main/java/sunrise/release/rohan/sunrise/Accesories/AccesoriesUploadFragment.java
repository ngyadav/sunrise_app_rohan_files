...
public class AccesoriesUploadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_accesories_upload, container, false);
        ...
        mSearch=(TextView)v.findViewById(R.id.mobile_upload_search);
             ...
             areas.add("CABLES");
             areas.add("POWERBANK");
             areas.add("CONNECTORS");
             areas.add("POUCHES");
             areas.add("TEMPEREDGLASS");
             areas.add("OTHERS");
        ...
        mSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference ref= FirebaseDatabase.getInstance().getReference().child("Category").child("Accesories").child(mName.getText().toString());
                ...
                if(temp==0) {
                    ...
                    ref.child("Category").setValue("Accesories");
        ...
        mSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference ref = database.child("Category").child("Accesories");
                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild(mName.getText().toString())) {
                            DatabaseReference ref = database.child("Category").child("Accesories").child(mName.getText().toString());
                            ref.addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    Accesories mobile = dataSnapshot.getValue(Accesories.class);
