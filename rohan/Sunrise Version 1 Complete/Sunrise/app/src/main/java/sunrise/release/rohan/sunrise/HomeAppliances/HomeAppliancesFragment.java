...
import sunrise.release.rohan.sunrise.HomeAppliances.ViewHolder;
...
public class HomeAppliancesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_home_appliances, container, false);
...
//        mRecyclerView.setLayoutManager(new GridLayoutManager(getContext(), 2));
            ...
            public void onClick(View v) {
                ...
                FirebaseRecyclerAdapter<Home, ViewHolder> firebaseRecyclerAdapter =
                        new FirebaseRecyclerAdapter<Home, ViewHolder>(
                            ...
                            @Override
                            protected void populateViewHolder(ViewHolder viewHolder, Home profile, int position) {
                            ...
                            public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                                ...
                                viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                                    ...
                                    public void onItemClick(View v, int position) {
                                        ...
                                        HomeAppliancesDetails fragment= new HomeAppliancesDetails();
        ...
        hwashing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                shimmer.setVisibility(View.VISIBLE);
                shimmer.startShimmer();
                session.setsub("HomeAppliances WASHING");
                Query firebasequery=mref.orderByChild("CategoryType").equalTo("HomeAppliances WASHING");
                FirebaseRecyclerAdapter<Home, ViewHolder> firebaseRecyclerAdapter =
                        new FirebaseRecyclerAdapter<Home, ViewHolder>(
                                Home.class,
                                R.layout.cardview_mobile,
    ...
    private  void firebasesearch(final String searchText)
    {
        ...
        shimmer.setVisibility(View.VISIBLE);
        shimmer.startShimmer();
        Query firebasesearchquery = mref.orderByChild("Category").equalTo("HomeAppliances");
