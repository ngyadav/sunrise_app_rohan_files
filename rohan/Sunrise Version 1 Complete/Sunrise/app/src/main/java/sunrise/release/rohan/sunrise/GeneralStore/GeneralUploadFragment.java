package sunrise.release.rohan.sunrise.GeneralStore;
...
public class GeneralUploadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_general_upload, container, false);
        ...
        mSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference ref= FirebaseDatabase.getInstance().getReference().child("Category").child("General").child(mName.getText().toString());
                ...
                if(temp==0) {
                    ...
                    ref.child("Category").setValue("General");
        ...
        mSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference ref = database.child("Category").child("General");
                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild(mName.getText().toString())) {
                            DatabaseReference ref = database.child("Category").child("General").child(mName.getText().toString());
                            ref.addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    General mobile = dataSnapshot.getValue(General.class);
