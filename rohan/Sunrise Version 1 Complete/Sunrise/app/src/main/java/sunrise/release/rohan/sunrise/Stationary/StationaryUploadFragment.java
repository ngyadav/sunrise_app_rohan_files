package sunrise.release.rohan.sunrise.Stationary;
...
public class StationaryUploadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_stationary_upload, container, false);
        ...
        mSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference ref= FirebaseDatabase.getInstance().getReference().child("Category").child("Stationary").child(mName.getText().toString());
                ...
                if(temp==0) {
                    ...
                    ref.child("Category").setValue("Stationary");
        ...
        mSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference ref = database.child("Category").child("Stationary");
                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild(mName.getText().toString())) {
                            DatabaseReference ref = database.child("Category").child("Stationary").child(mName.getText().toString());
                            ref.addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    Stationary mobile = dataSnapshot.getValue(Stationary.class);
