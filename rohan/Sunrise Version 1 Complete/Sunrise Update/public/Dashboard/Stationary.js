...
var firebaseref=firebase.database().ref().child("Category");
    return firebaseref.orderByChild("Category").equalTo("Stationary").once('value').then(function(snapshot) {
...
addbtn.addEventListener('click',function(){
 ...
 var task = ref.child("Category").child("Stationary").child(name1).put(file, metadata);
 ...
 var task2 = ref.child("Category").child("Stationary").child(name2).put(file2, metadata2);
 ...
 var task3 = ref.child("Category").child("Stationary").child(name3).put(file3, metadata3);
...
var image3=document.getElementById("image3");
  ...
  firebaseref.child("Type").set(typeacc.value);
  firebaseref.child("Brand").set(brand.value);
  firebaseref.child("Category").set("Stationary");
  firebaseref.child("CategoryName").set("Stationary "+name.value.trim());
  firebaseref.child("CategoryType").set("Stationary "+typeacc.value);
  firebaseref.child("CategoryBrand").set("Stationary "+brand.value);
