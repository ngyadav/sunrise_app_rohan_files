...
addbtn.addEventListener("click",function(){
    ...
    var task = ref.child("Category").child("Fashion").child(name1).put(file, metadata);
    ...
    var task2 = ref.child("Category").child("Fashion").child(name2).put(file2, metadata2);
    ...
    var task3 = ref.child("Category").child("Fashion").child(name3).put(file3, metadata3);
...
var image3=document.getElementById("image3");
    ...
    firebaseref.child("CategoryType").set("Fashion "+typeacc.options[typeacc.selectedIndex].value);
...
var stock=document.getElementById('stock');
    ...
    return firebaseref.once('value').then(function(snapshot) {
        ...
        var temp=snapshot.val().Size.toString();
        size.value=temp.substring(0,(temp.length-1));
...
deletebtn.addEventListener('click',function(){
  ...
  if(name.value.length==0)
  {
    ...
    firebaseref.child("Size").set(null);
