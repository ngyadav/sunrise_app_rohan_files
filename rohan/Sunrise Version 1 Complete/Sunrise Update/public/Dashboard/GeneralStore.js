...
var firebaseref=firebase.database().ref().child("Category");
    return firebaseref.orderByChild("Category").equalTo("General").once('value').then(function(snapshot) {
...
addbtn.addEventListener('click',function(){
 ...
 var task = ref.child("Category").child("General").child(name1).put(file, metadata);
 ...
 var task2 = ref.child("Category").child("General").child(name2).put(file2, metadata2);
 ...
 var task3 = ref.child("Category").child("General").child(name3).put(file3, metadata3);
...
var image3=document.getElementById("image3");
  ...
  firebaseref.child("Category").set("General");
  firebaseref.child("CategoryName").set("General "+name.value.trim());
  firebaseref.child("CategoryType").set("General "+typeacc.options[typeacc.selectedIndex].value);
  firebaseref.child("CategoryBrand").set("General "+brand.value); 
