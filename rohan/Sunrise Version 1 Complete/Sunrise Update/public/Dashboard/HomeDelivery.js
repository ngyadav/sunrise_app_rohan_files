...
var firebaseref=firebase.database().ref().child("Category");
    return firebaseref.orderByChild("Category").equalTo("HomeDelivery").once('value').then(function(snapshot) {
...
addbtn.addEventListener("click",function(){
    ...
    var task = ref.child("Category").child("HomeDelivery").child(name1).put(file, metadata);
    ...
    var task2 = ref.child("Category").child("HomeDelivery").child(name2).put(file2, metadata2);
    ...
    var task3 = ref.child("Category").child("HomeDelivery").child(name3).put(file3, metadata3);
...
var image3=document.getElementById("image3");
    ...
    firebaseref.child("Type").set(typeacc.options[typeacc.selectedIndex].value);
    firebaseref.child("Brand").set(brand.value);
    firebaseref.child("Category").set("HomeDelivery");
    firebaseref.child("CategoryName").set("HomeDelivery "+name.value.trim());
  firebaseref.child("CategoryType").set("HomeDelivery "+typeacc.options[typeacc.selectedIndex].value);
  firebaseref.child("CategoryBrand").set("HomeDelivery "+brand.value);
...
deletebtn.addEventListener('click',function(){
  ...
  if(name.value.length==0)
  {
    ...
    firebaseref.child("CategoryBrand").set(null);
