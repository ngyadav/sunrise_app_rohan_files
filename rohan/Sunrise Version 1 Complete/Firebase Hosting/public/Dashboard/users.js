    ...
    if(name.value==='')
     ...
     if(password.value!==cpassword.value)
     {
        ...
        if(document.getElementById('role8').checked==true)
          ...
          if(document.getElementById('role12').checked==true)
          $role =$role+document.getElementById('role12').value+",";
          if(document.getElementById('role13').checked==true)
          $role =$role+document.getElementById('role13').value+",";
          console.log($role);
        ...
        //   document.getElementById('role5').checked=false;
          ...
          document.getElementById('role12').checked=false;
          document.getElementById('role13').checked=false;
