...
var firebaseref=firebase.database().ref().child("Category");
    return firebaseref.orderByChild("Category").equalTo("NewArrival").once('value').then(function(snapshot) {
...
addbtn.addEventListener("click",function(){
    ...
    var task = ref.child("Category").child("NewArrival").child(name1).put(file, metadata);
    ...
    var task2 = ref.child("Category").child("NewArrival").child(name2).put(file2, metadata2);
    ...
    var task3 = ref.child("Category").child("NewArrival").child(name3).put(file3, metadata3);
...
var image3=document.getElementById("image3");
    ...
    firebaseref.child("Category").set("NewArrival");
    firebaseref.child("CategoryName").set("NewArrival "+name.value.trim());
    firebaseref.child("CategoryType").set("NewArrival "+typeacc.options[typeacc.selectedIndex].value);
    firebaseref.child("CategoryBrand").set("NewArrival "+brand.value); 
