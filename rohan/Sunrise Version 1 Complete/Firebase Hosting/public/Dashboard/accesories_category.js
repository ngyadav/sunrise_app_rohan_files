...
addbtn.addEventListener("click",function(){
    ...
    var task = ref.child("Category").child("Accesories").child(name1).put(file, metadata);
    ...
    var task2 = ref.child("Category").child("Accesories").child(name2).put(file2, metadata2);
    ...
    var task3 = ref.child("Category").child("Accesories").child(name3).put(file3, metadata3);
...
var image3=document.getElementById("image3");
    ...
    firebaseref.child("CategoryType").set("Accesories "+typeacc.options[typeacc.selectedIndex].value);
