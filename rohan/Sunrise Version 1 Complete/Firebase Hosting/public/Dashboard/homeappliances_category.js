...
submitbtn.addEventListener('click',function(){
  ...
  firebaseref.child("CategoryType").set("HomeAppliances "+typeacc.options[typeacc.selectedIndex].value);
...
addbtn.addEventListener('click',function(){
    if($('#image1').get(0).files.length==0){
     ...
     var task = ref.child("Category").child("HomeAppliances").child(name1).put(file, metadata);
     ...
     var task2 = ref.child("Category").child("HomeAppliances").child(name2).put(file2, metadata2);
     ...
     var task3 = ref.child("Category").child("HomeAppliances").child(name3).put(file3, metadata3);
